...
data_set_chn = [
    ...
    # [interface.get_stock_1w_hfq_k_data,          Provider.BaoStock, 0, "Stock Weekly HFQ K-Data",  24],
    # [interface.get_stock_1mon_hfq_k_data,        Provider.BaoStock, 0, "Stock Monthly HFQ K-Data", 24],
    # [interface.get_stock_1h_hfq_k_data,          Provider.BaoStock, 0, "Stock 1 hours HFQ K-Data", 24],
    # [interface.get_stock_30m_hfq_k_data,         Provider.BaoStock, 0, "Stock 30 mins K-Data",     24],
    # [interface.get_stock_15m_hfq_k_data,         Provider.BaoStock, 0, "Stock 15 mins HFQ K-Data", 24],
    # [interface.get_stock_5m_hfq_k_data,          Provider.BaoStock, 0, "Stock 5 mins HFQ K-Data",  24],
    # [interface.get_stock_1m_hfq_k_data,          Provider.BaoStock, 0, "Stock 1 mins HFQ K-Data",  24],
]
...
def fetch_data(lock, region: Region, pc):
    ...
    if region == Region.CHN:
        ...
        interface.get_stock_list_data(Provider.BaoStock)

...
from findy.vendor.wechatpy.crypto import WeChatRefundCrypto
from findy.vendor.wechatpy.utils import random_string
from findy.vendor.wechatpy.exceptions import WeChatPayException, InvalidSignatureException
from findy.vendor.wechatpy.pay.utils import (
    calculate_signature,
    calculate_signature_hmac,
    _check_signature,
    dict_to_xml,
)
from findy.vendor.wechatpy.pay.api.base import BaseWeChatPayAPI
from findy.vendor.wechatpy.pay import api
...
class WeChatPay:
    ...
    def get_payment_data(cls, xml):
        ...
        使用示例::
            ...
            from findy.vendor.wechatpy.pay import WeChatPay

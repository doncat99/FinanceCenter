...
from findy.vendor.wechatpy.fields import (
    StringField,
    IntegerField,
    ImageField,
    VoiceField,
...
from findy.vendor.wechatpy.messages import BaseMessage, MessageMetaClass
...
def deserialize_reply(xml, update_time=False):
    ...
    :rtype: findy.vendor.wechatpy.replies.BaseReply
    """
    if not xml:
        return EmptyReply()
